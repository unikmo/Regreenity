...
const fallbackDetails: Record<string, string[]> = {
  ...
  '/resort-live-demo/': ['Interactive resort guest experience', 'Five-minute in-stay rating demo with 10 standard 1–10 questions', 'Illustrative resort-team recovery and automatic-publication view'],
  ...
  '/hotel-guest-rating-software/': ['Maximum five-minute in-stay rating flow', 'Exactly 10 standard guest pain-point questions scored 1–10', 'Separate 400-character good and improvement comments with automatic publication for participating properties'],
