...
process.env.RESEND_API_KEY='test-key';process.env.REGREENITY_ENQUIRY_TO='info@regreenity.com';process.env.REGREENITY_ENQUIRY_FROM='Regreenity <notifications@regreenity.com>'
...
assert.equal(requestBody.to[0],'info@regreenity.com');assert.match(requestBody.text,/access-controlled Regreenity portal/)
