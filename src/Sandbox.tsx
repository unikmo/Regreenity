...
export default function Sandbox(){
  ...
  return <main className="sandbox-shell">
    <header><a href="/">Tisonik</a><div><span className={ready?'ready':''}/>{ready?'Reference host connected':'Connecting…'}</div><a href="/portal/">Operator portal</a></header>
    <section className="sandbox-intro"><p>CRUISECONNECT 1.0 · EXECUTABLE SANDBOX</p><h1>One sailing. Every journey. No passenger data in Tisonik cloud.</h1><span>This sandbox runs the same versioned SDK contract supplied to cruise-line app teams. Choose a module, execute it, then inspect the host-side result.</span></section>
