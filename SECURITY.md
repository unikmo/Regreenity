...
Report suspected vulnerabilities privately to `info@tisonik.com`. Do not include passenger, crew, booking, biometric or payment data in a report. Tisonik will acknowledge a report, triage severity, coordinate remediation and publish a release only after the fix and regression tests pass.
